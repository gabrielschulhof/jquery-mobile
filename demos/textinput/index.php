...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
    ...
    <div role="main" class="ui-content jqm-content">
        ...
        <form>
            ...
            <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset ui-input-has-action">
                <input type="text" data-enhanced="true" data-clear-btn="true" name="text-enhanced" id="text-enhanced" value="">
                <a href="#" class="ui-input-action ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all ui-input-action-hidden" title="Clear text">Clear text</a>
            </div>

            <label for="search-enhanced">Search:</label>
            <div class="ui-input-search ui-body-inherit ui-corner-all ui-shadow-inset ui-input-has-action">
