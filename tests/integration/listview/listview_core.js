...
asyncTest( "Presence of ui-listview-item-has- classes", function() {
	$.testHelper.pageSequence( [
		function() {
		...
		function() {
			...
			ok( items.eq( 0 ).find( "a" ).first().hasClass( "ui-icon-caret-r" ),
			...
			ok( items.eq( 1 ).find( "a" ).first().hasClass( "ui-icon-caret-r" ),
			...
			ok( !items.eq( 2 ).find( "a" ).first().hasClass( "ui-icon-caret-r" ),
			...
			ok( !items.eq( 3 ).find( "a" ).first().hasClass( "ui-icon-caret-r" ),
			...
			ok( !items.eq( 4 ).find( "a" ).first().hasClass( "ui-icon-caret-r" ),
